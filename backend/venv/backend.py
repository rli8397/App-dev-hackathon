...
def getRequests(columns: str, table: str, conditions: str, queryVals: list):
    conn = sqlite3.connect(table)
    c = conn.cursor()
    executeVals = [columbs, table]
    executeVals += queryVals
    result = queryToJSON(
...
async def root(title: str = '', sender: str = '', date: str=''):
    ...
    if (sender != ''):
        ...
        searchConditions += "sender=" + sender
